...
export const Controls: React.FC<{
	...
	return (
		<div
			ref={ref}
			style={{...containerCss, backdropFilter: 'blur(10px)', backgroundColor: 'rgba(0, 0, 0, 0.3)'}}
			onPointerDown={onPointerDownIfContainer}
			onDoubleClick={onDoubleClickIfContainer}
		>
			<div ref={flexRef} style={controlsRow}>
				<div style={leftPartStyle} className='editor-player-controls-left'>
					<button
						ref={playButtonRef}
						type="button"
				...
				<div style={fullscreen} className='editor-player-controls-fullscreen'>
